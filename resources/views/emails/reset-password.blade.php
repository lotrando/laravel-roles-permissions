...
<html lang="cs">
  ...
  <head>
    ...
    <meta name="description" content="Obnova hesla pro váš účet.">
    <style>
      @charset "UTF-8";
...
*/
      ...
      body[data-bs-theme=dark] [data-bs-theme=light] .btn-close {
        filter: var(--tblr-btn-close-white-filter);
      }
          ...
          <div class="card card-md">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-10">
                  <h3>{{ __('Good day') }}{{ $user->name ? ', ' . $user->name : '' }}!</h3>
                  <div class="markdown text-secondary">
                    <p>{{ __('You are receiving this email because we received a password reset request for your account.') }}<br><br>
                      {{ __('Click the button below to reset your password') }}</p>
                  </div>
                  <div class="mt-3">
                    <a class="btn btn-primary" href="{{ $url }}" target="_blank" rel="noopener">
                      <svg class="icon icon-tabler icons-tabler-outline icon-tabler-lock-open" width="24" height="24" viewBox="0 0 24 24" fill="none"
